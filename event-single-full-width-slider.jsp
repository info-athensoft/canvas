        ...
        <section id="slider" class="slider-parallax swiper_wrapper clearfix" style="height: 600px;">
            ...
            <div class="swiper-container swiper-parent">
                <div class="swiper-wrapper">
                    <div class="swiper-slide" style="background-image: url('images/events/10.jpg');"></div>
                    <div class="swiper-slide" style="background-image: url('images/events/parallax/1.jpg');"></div>
                    <div class="swiper-slide" style="background-image: url('images/events/parallax/7.jpg');"></div>
                </div>
